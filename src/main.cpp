...
void run_simulation(
    ...
    for (int i = 0; i < num_freqs; ++i) {
        ...
        cuDoubleComplex* A_device = get_full_interaction_matrix_scalar_1Dperiodic(A_host.data(), positions.data(), alpha.data(), angles.data(), N, k, vec3{1365.0e-9, 0.0, 0.0}, 200);

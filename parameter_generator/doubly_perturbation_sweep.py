...
if __name__ == "__main__":
    ...
    run_and_measure(True, f"doubly_perturbed_2x2_40nm", 40)
    run_and_measure(True, f"doubly_perturbed_2x2_60nm", 60)
    run_and_measure(True, f"doubly_perturbed_2x2_80nm", 80)
    run_and_measure(True, f"doubly_perturbed_2x2_80nm", 100)
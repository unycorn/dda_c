...
if __name__ == "__main__":
    ...
    lattices = {
        ...
        2: ('square', create_square_lattice(lattice_spacing, 3e-6)),
        3: ('square', create_square_lattice(lattice_spacing, 4e-6)),
        4: ('square', create_square_lattice(lattice_spacing, 5e-6)),
        5: ('square', create_square_lattice(lattice_spacing, 10e-6)),
        6: ('square', create_square_lattice(lattice_spacing, 15e-6)),
        7: ('square', create_square_lattice(lattice_spacing, 20e-6)),
        8: ('square', create_square_lattice(lattice_spacing, 30e-6)),
    }

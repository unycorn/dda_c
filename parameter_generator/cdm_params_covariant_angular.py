...
if __name__ == "__main__":
    ...
    resonator_files = {
        ...
        # 'c-shape-36': 'FullCovariance_gaussian_model_cshape_36.npz',
        # 'c-shape-28': 'FullCovariance_gaussian_model_cshape_28.npz',
        'u-shape-ideal': 'u-shape-ideal-cdm-param_NoRadLoss.csv',
        # 'u-shape-37': 'FullCovariance_gaussian_model_ushape_37.npz',
        # 'u-shape-29': 'FullCovariance_gaussian_model_ushape_29.npz'
    }

    lattice_sizes = np.array([1.1e-6, 2.1e-6, 3.1e-6, 4.1e-6, 5.1e-6, 10.1e-6, 20.1e-6, 30.1e-6])
    # Dictionary to store all lattice types
    lattices = {
        i: ('square', create_square_lattice(lattice_spacing, size)) for i, size in enumerate(lattice_sizes)
    }
